...
public class TaskListTest extends AbstractTaskListTest {
    ...
    @Test
    public void toStringAllLists() {
        Task[] ts = {new Task("Aa", 58), new Task("Bb", 67),new Task("Cc", 90),new Task("Dd", 456)};
        addAll(ts);
...
//        Task[] ts = {new Task("Aa", 58), new Task("Bb", 67),new Task("Cc", 90),new Task("Dd", 456)};
//        addAll(ts);
//        assertEquals(67, tasks.getMax());
//        System.out.println(tasks.getMax());
//    }
    ...
    public void testIncoming() {
        ...
        Task[] ts = {
            ...
            task("Repeat left intersect IN", 0, 60, 30, true), //не заходит в диапазон
